      ...
      <div className="navbar-top">
        ...
        <div className="navbar-top-right">
          <a href="https://www.facebook.com/chambimbe.colectivo.cultural" target="_blank" rel="noopener noreferrer">
            <img src={assets.facebook_icon_black} alt="Facebook" className="icon" />
          </a>
          <a href="https://www.youtube.com/channel/UCT-_4L5NIU69FB027fyHNGg" target="_blank" rel="noopener noreferrer">
            <img src={assets.youtube_icon_black} alt="YouTube" className="icon" />
          </a>
        </div>
      </div>
      <div className="menu">
        ...
        <img src={assets.logo_indigena} alt="Logo Indigena" className="icon" />
